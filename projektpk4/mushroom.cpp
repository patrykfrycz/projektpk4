...
Mushroom::Mushroom(float x, float y) : Item(ItemType::Mushroom, x, y, 32.f, 32.f) {
    vecspeed = { 150.f, -200.f };
}

void Mushroom::initTexture(const sf::Texture& texture) {
...
void Mushroom::draw(sf::RenderWindow& window) const {
...
void Mushroom::resolveCollision(const Platform& platform) {
